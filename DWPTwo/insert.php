...
// prepare and bind 
// prepare statement beskytter for sql injections
...
$Username = htmlspecialchars(trim($_POST['user'])); //XSS, 
...
$comment = "INSERT INTO `Comment` (`CommentID`, `CommentText`, `MediaCommentFK`, `dato`, `ProfileFK`) VALUES ('$CommentID', '$CommentText', '$MediaCommentFK', '$dato', '$ProfileFK');";
