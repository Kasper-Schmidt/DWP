...
<div class="imageModal">
    <?php
    $sql = "SELECT
        Profile.ProfileID, Profile.Username, Profile.Fname, Profile.Lname, Profile.Avatar, Media.URL, Media.mediaTitle, Media.mediaDesc, Media.MediaID, 
    ...
    ORDER BY
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<img id="imageDisplay" width="324px" height="576p" src="' . $row["URL"] . '" alt="' . '">';
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="popupRight">
                        ...
                        require("getComments.inc.php");
                        echo '</div>';


                        //$MediaID = 3;
                        echo "<form method='POST' action='createComment.inc.php'>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.like-button').on('click', function() {
                handleLikeOrDislike(1, $(this), 'like.php');
            });
